...
// PARAMETERS
// ────────────────────────────────
params.raw_glob     = "{Path}/Automate/Raw/*_R{1,2}.fastq.gz"                      // Path for Raw data
params.fastqc_out   = "{Path}/Automate/01_QC/raw_read_qc/fastqc_reports"           // Path for QC report
...
params.deliverables = "{Path}/Automate/02_Processedreads"   // Path of Processed data
